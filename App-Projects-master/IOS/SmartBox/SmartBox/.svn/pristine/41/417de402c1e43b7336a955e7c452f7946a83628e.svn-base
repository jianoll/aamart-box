...
//  addressList
//
//  Created by yang kong on 12-5-10.
//  Copyright 2012 __MyCompanyName__. All rights reserved.
//
// 用法:NSString *iPname = [HostManager getIPAddressForHostString:@"conn.365car.com.cn"];
...
static HostManager* kOnlyOne = nil;
+ (HostManager*)getInstance
{
	if (kOnlyOne == nil) {
		kOnlyOne = [[HostManager alloc] init];
	}
	return kOnlyOne;
}
