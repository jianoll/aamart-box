...
#import "PKListMileageOfWeekTableViewController.h"
...
//        if (repondData != nil) {
//            NSLog(@"getUserPointOfDate callback");
//        }
//    }];
    
    PKListTableViewController *listViewController1 = [[PKListTableViewController alloc] initWithStyle:UITableViewStylePlain];
    PKListMileageOfWeekTableViewController *listViewController2 = [[PKListMileageOfWeekTableViewController alloc] initWithStyle:UITableViewStylePlain];
    PKListTotalScoreTableViewController *listViewController3 = [[PKListTotalScoreTableViewController alloc] initWithStyle:UITableViewStylePlain];
    
    //listViewController2.userInfo =
