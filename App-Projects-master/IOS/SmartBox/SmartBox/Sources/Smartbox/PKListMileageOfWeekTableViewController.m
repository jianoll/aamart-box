//
//  PKListMileageOfWeekTableViewController.m
//  Smartbox
//
...
#import "PKCell.h"
@interface PKListMileageOfWeekTableViewController ()

@end

@implementation PKListMileageOfWeekTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [[AFAppDotNetAPIClient sharedClient] getUserMileageOfWeek:nil endDate:nil complete:^(NSArray *repondData, NSError *error) {
        if (repondData != nil) {
            ...
            NSLog(@"getUserMileageOfWeek callback");
        }
    }];
