...
- (void)viewDidLoad {
    ...
    if (self.personInfo != nil) {
        self.userIDLabel.text = [self.personInfo valueForKey:@"userId"];
        self.userNickNameLabel.text = [self.personInfo valueForKey:@"nickName"];
        self.userPhoneLabel.text = [self.personInfo valueForKey:@"mobileNo"];
        self.userSexLabel.text = [[self.personInfo valueForKey:@"sex"] isEqualToString:@"1"] ? @"男" : @"女";
    }
