...
-(void)strokeChart
{
    ...
    for (NSDictionary * valuedic in _chardata) {
        ...
        bar.strValue = [self removeEscapeFrom:[NSString stringWithFormat:@"%ld", (long)[value integerValue]] ];
        bar.grade = grade;
...
//        
        ...
        bar2.strValue = [self removeEscapeFrom:[NSString stringWithFormat:@"%ld", (long)[value2 integerValue]] ];
        bar2.grade = grade2;
