...
{
    if (![self.expandedIndexPaths[indexPath.section] containsObject:indexPath]) {//miancell
...
//        [_SKSTableViewDelegate tableView:tableView didDeselectRowAtIndexPath:indexPath];
    ...
    if (![self.expandedIndexPaths[indexPath.section] containsObject:indexPath])//main
    {
        //do nothing,bobo
    }
    else
    {
        ...
        {
            NSIndexPath *indexPathForSubrow = [self correspondingIndexPathForSubRowAtIndexPath:indexPath];
             [_SKSTableViewDelegate tableView:tableView didSelectSubRowAtIndexPath:indexPathForSubrow];
        }
    }
    ...
    if (![self.expandedIndexPaths[indexPath.section] containsObject:indexPath])//main
        {
            if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:heightForRowAtIndexPath:)])
                return [_SKSTableViewDelegate tableView:(SKSTableView *)tableView heightForRowAtIndexPath:indexPath];
        }
        else
        {
            if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:heightForSubRowAtIndexPath:)])
                return[_SKSTableViewDelegate tableView:(SKSTableView *)tableView heightForSubRowAtIndexPath:indexPath];
        }
